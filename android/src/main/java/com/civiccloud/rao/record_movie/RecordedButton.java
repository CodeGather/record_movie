...
//                downY = moveY;
    ...
    public void setParame(float max, double width, String color, String bgColor){
        this.max = max;
//        this.dp5 = px2dip(this, width);
        this.colorBlue = Color.parseColor(color);
        this.colorGray = Color.parseColor(bgColor);
        Log.d(TAG, "setParame: " + dip2px(this,6));
    }

    public static int dip2px(RecordedButton context, double dipValue) {
        final float scale = context.getResources().getDisplayMetrics().density;
        return (int) (dipValue * scale + 0.5f);
    }

    public static int px2dip(RecordedButton context, double pxValue) {
        final float scale = context.getResources().getDisplayMetrics().density;
